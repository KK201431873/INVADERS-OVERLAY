...
public class DraggableComponent {
    ...
    public void draw(int mouseX, int mouseY){
        ...
        boolean mouseOverX = (mouseX >= this.getxPosition()-this.getWidth() && mouseX <= this.getxPosition());
        boolean mouseOverY = (mouseY >= this.getyPosition()-this.getHeight() && mouseY <= this.getyPosition()+this.getHeight());
